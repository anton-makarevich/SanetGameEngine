...
namespace Sanet.Polygame.Controls.Writer;
...
public class DrawingSurface : GameObject2D
{
    ...
    public bool CanUndo => _undoObjects.Any();
    ...
    {
        var line = new Line(start-LocalPosition, end-LocalPosition);
        ...
        segment.Initialize();
        segment.LoadContent(SceneManager.SceneManager.RenderContext.GlobalContentManager,IsLocalContent);
