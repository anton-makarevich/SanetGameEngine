...
namespace Sanet.Polygame.Geometry;
...
public class Line
{
    ...
    public Vector2 WorldPoint1 => Point1 * SceneManager.SceneManager.RenderContext.DeviceScale;

    public Vector2 WorldPoint2 => Point2* SceneManager.SceneManager.RenderContext.DeviceScale;

    public float Lenth => _length;
