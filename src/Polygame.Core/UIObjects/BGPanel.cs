...
public class BGPanel : GameObject2D
{
    ...
    public float Width => _leftPart.Width * 2 + MainWidth;

    public float Height => _topPart.Height*2+MainWidth;
    ...
    public Vector2 Padding => new(_leftPart.Width, _topPart.Height);
